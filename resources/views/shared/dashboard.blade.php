            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_pallets'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['pallets_with_location'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['pallets_without_location'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_locations'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['pending_deliveries'] ?? 0 }}</h3>
                    </div>
...
<div class="row">
    <div class="col-12 col-sm-6 col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #0C7779;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-plus-circle" dashboard-action-icon" style="font-size: 3rem; color: #0C7779;"></i>
                </div>
    ...
    <div class="col-12 col-sm-6 col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #249E94;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-eye" dashboard-action-icon" style="font-size: 3rem; color: #249E94;"></i>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_orders'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['today_orders'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['pending_orders'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['approved_orders'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['completed_orders'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['pending_approval'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_stok_pcs'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_stok_items'] ?? 0 }}</h3>
                    </div>
...
<div class="row">
    <div class="col-12 col-sm-6 col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #ff6b6b;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-clipboard-check" dashboard-action-icon" style="font-size: 3rem; color: #ff6b6b;"></i>
                </div>
    ...
    <div class="col-12 col-sm-6 col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #0C7779;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-truck" dashboard-action-icon" style="font-size: 3rem; color: #0C7779;"></i>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_pcs'] ?? 0 }}</h3>
                    </div>
                    <i class="bi bi-capsule" style="font-size: 2.5rem; color: #17a2b8; opacity: 0.7;"></i>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['completed_orders_today'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_deliveries'] ?? 0 }}</h3>
                    </div>
                    <i class="bi bi-truck" style="font-size: 2.5rem; color: #17a2b8; opacity: 0.7;"></i>
                </div>
            </div>
...
<div class="row">
    <div class="col-12 col-sm-6 col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #0C7779;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-eye" dashboard-action-icon" style="font-size: 3rem; color: #0C7779;"></i>
                </div>
                <h5 class="card-title" style="color: #1f2937;">Lihat Stok</h5>
                <p class="card-text" style="color: #9ca3af; margin-bottom: 1.5rem;">
    ...
    <div class="col-12 col-sm-6 col-md-6 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #28a745;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-file-earmark-bar-graph" dashboard-action-icon" style="font-size: 3rem; color: #28a745;"></i>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['pending_scan_issues'] ?? 0 }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ $stats['total_items'] ?? 0 }}</h3>
                    </div>
...
<div class="row">
    <div class="col-12 col-sm-6 col-md-4 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #0C7779;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-gear" dashboard-action-icon" style="font-size: 3rem; color: #0C7779;"></i>
                </div>
    ...
    <div class="col-12 col-sm-6 col-md-4 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #ff6b6b;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-exclamation-triangle" dashboard-action-icon" style="font-size: 3rem; color: #ff6b6b;"></i>
                </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        ...
                        <h3 class="dashboard-stat-value" style="color: #1f2937;">{{ (int) ($stats['total_box'] ?? 0) }}</h3>
                    </div>
...
<div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-3 mb-4">
        <div class="card shadow-sm border-0 h-100" style="background: #f5f7fa; border-top: 4px solid #17a2b8;">
            <div class="card-body text-center">
                <div class="mb-3">
                    <i class="bi bi-eye" dashboard-action-icon" style="font-size: 3rem; color: #17a2b8;"></i>
                </div>
        ...
        <div class="alert border-0 shadow-sm" style="background: #f0f4f8; border-left: 4px solid #5b8fc4;" role="alert">
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <p class="dashboard-stat-value" style="color: #7d8fa3;">Sistem ini membantu Anda mengelola stok barang di warehouse dengan scan barcode dan pelacakan lokasi penyimpanan yang terstruktur.</p>
                </div>
            </div>
        </div>
    </div>
